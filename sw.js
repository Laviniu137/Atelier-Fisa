const CACHE_NAME = 'fisa-atelier-v261';
const APP_FILES = [
  './',
  './index.html',
  './sw.js?v=1.22.16',
  ...
  './inventory-1.22.16.css?v=1.22.16',
  './inventory-1.22.16.js?v=1.22.16',
  './pdfjs-6.3.289.min.mjs',
  './pdfjs-worker-6.3.289.min.mjs',
  './notes/pdf-lib.min.js',
  './manifest.webmanifest',
  './icon-180.png?v=1.22.16',
  './icon-192.png?v=1.22.16',
  './icon-512.png?v=1.22.16'
];
