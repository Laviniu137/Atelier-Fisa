const CACHE_NAME = 'fisa-atelier-v252';
const APP_FILES = [
  './',
  './index.html',
  './sw.js?v=1.22.7',
  './notes/notes-editor.css?v=1.22.7',
  './notes/notes-editor.js?v=1.22.7',
  './notes/pdf-lib.min.js',
  './manifest.webmanifest',
  './icon-180.png?v=1.22.7',
  './icon-192.png?v=1.22.7',
  './icon-512.png?v=1.22.7'
];
