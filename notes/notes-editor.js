...
(() => {
  ...
  class NoteEditor {
    ...
    exportMenu(){
      ...
      const groups=[
        ['Document',[['PDF · toate paginile','PDF','Un fișier cu toate paginile A4',async()=>download(await Export.pdf(this.note),filename(this.note.title)+'.pdf')],['Print A4','A4','Tipărește notița la dimensiune A4',async()=>Export.print(this.note)]]],
